...
if args.ckpt is not None:
    encoder.load_state_dict(torch.load(os.path.join(args.ckpt, "encoder_second.ckpt")))
    decoder.load_state_dict(torch.load(os.path.join(args.ckpt, "decoder_second.ckpt")))
